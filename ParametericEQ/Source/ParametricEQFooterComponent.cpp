...
ParametricEQFooterComponent::ParametricEQFooterComponent()
{
...
void ParametricEQFooterComponent::applyFonts()
{
...
void ParametricEQFooterComponent::lookAndFeelChanged()
{
...
void ParametricEQFooterComponent::paint (juce::Graphics& g)
{
    g.fillAll (getLookAndFeel().findColour (juce::ResizableWindow::backgroundColourId));
}

void ParametricEQFooterComponent::resized()
{
...
int ParametricEQFooterComponent::getMinimumContentWidth (int heightHint)
{
