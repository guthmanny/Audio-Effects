...
void ParametricEQHeaderComponent::setupMeter (atom::MeterBar& meter, int barCount)
{
...
void ParametricEQHeaderComponent::setMeterLevels (float left, float rightL, float rightR)
{
    meterLeftLevel = left;
...
void ParametricEQHeaderComponent::paint (juce::Graphics& g)
{
    g.fillAll (getLookAndFeel().findColour (juce::ResizableWindow::backgroundColourId));
}

void ParametricEQHeaderComponent::resized()
{
    using juce::FlexBox;
    using juce::FlexItem;
...
int ParametricEQHeaderComponent::getMinimumContentWidth (int heightHint)
{
    ...
    const int content = meterW + 16 + inW + 12 + cogSize + 12 + outW + 12 + meterW * 2 + 16;
