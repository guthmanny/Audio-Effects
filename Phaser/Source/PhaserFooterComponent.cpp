...
PhaserFooterComponent::PhaserFooterComponent()
{
...
void PhaserFooterComponent::applyFonts()
{
...
void PhaserFooterComponent::lookAndFeelChanged()
{
...
void PhaserFooterComponent::paint (juce::Graphics& g)
{
    g.fillAll (getLookAndFeel().findColour (juce::ResizableWindow::backgroundColourId));
}

void PhaserFooterComponent::resized()
{
...
int PhaserFooterComponent::getMinimumContentWidth (int heightHint)
{
