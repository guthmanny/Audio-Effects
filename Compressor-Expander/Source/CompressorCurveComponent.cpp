...
void CompressorCurveComponent::paint (juce::Graphics& g)
{
    ...
    constexpr float inputGridDb[] = { -60.0f, -48.0f, -36.0f, -24.0f, -12.0f, 0.0f };
    ...
    constexpr float outputGridDb[] = { -48.0f, -36.0f, -24.0f, -12.0f, 0.0f, 12.0f };
    ...
    // ---- Parameter readout ----
    const auto modeText = expanderMode ? juce::String ("Expander") : juce::String ("Compressor");
    ...
    const auto readout = modeText + "  |  Knee " + kneeText
                       ...
                       + juce::String (ratio, 1) + ":1  |  Makeup "
                       + (makeupDb > 0.0f ? "+" : "") + juce::String (makeupDb, 1) + " dB";
