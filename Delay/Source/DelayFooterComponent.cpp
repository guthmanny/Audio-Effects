...
DelayFooterComponent::DelayFooterComponent()
{
...
void DelayFooterComponent::applyFonts()
{
...
void DelayFooterComponent::lookAndFeelChanged()
{
...
void DelayFooterComponent::paint (juce::Graphics& g)
{
    g.fillAll (getLookAndFeel().findColour (juce::ResizableWindow::backgroundColourId));
}

void DelayFooterComponent::resized()
{
...
int DelayFooterComponent::getMinimumContentWidth (int heightHint)
{
