/*
  Custom Standalone entry point for Delay.
...
{
    // Delay is an effect — it needs input audio. Always unmute, overriding
...
class DelayStandaloneApp : public juce::JUCEApplication
{
public:
    DelayStandaloneApp()
    {
