...
void ChorusHeaderComponent::setupMeter (atom::MeterBar& meter, int barCount)
{
...
void ChorusHeaderComponent::setMeterLevels (float left, float rightL, float rightR)
{
    meterLeftLevel = left;
...
void ChorusHeaderComponent::timerCallback()
{
