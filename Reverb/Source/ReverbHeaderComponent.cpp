...
ReverbHeaderComponent::ReverbHeaderComponent()
{
...
ReverbHeaderComponent::~ReverbHeaderComponent() { stopTimer(); }

void ReverbHeaderComponent::setupMeter(atom::MeterBar& meter, int barCount)
{
...
void ReverbHeaderComponent::setMeterLevels(float left, float rightL, float rightR)
{
    meterLeftLevel = left;
...
void ReverbHeaderComponent::paint(juce::Graphics& g)
{
    g.fillAll(getLookAndFeel().findColour(juce::ResizableWindow::backgroundColourId));
}

void ReverbHeaderComponent::resized()
{
    using juce::FlexBox;
    using juce::FlexItem;
...
int ReverbHeaderComponent::getMinimumContentWidth(int heightHint)
{
