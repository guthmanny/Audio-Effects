/*
  Custom Standalone entry point for Reverb.
...
private:
    void syncFixedWindowSize()
    {
        ...
        if (getWidth() == expectedW && getHeight() == expectedH) { lastStableBounds = getScreenBounds(); return; }
...
class ReverbStandaloneApp : public juce::JUCEApplication
{
public:
    ReverbStandaloneApp()
    {
...
{
    return new ReverbStandaloneApp();
}
